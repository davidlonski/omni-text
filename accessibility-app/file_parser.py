...
def replace_images_with_videos(extracted_data, pptx_file):
    """
    Replaces images in a pptx file with videos from the extracted data.
    """

    parsed_pptx = parse_powerpoint(pptx_file)

    json_data = json.dumps(extracted_data)

    print(json.dumps(json_data, indent=4))
    print(json.dumps(parsed_pptx, indent=4))
